...
fun NavigateScreen(
    ...
    // ------------------------------------------------------------------------
    // Kiosk QR / Deep Link Destination
    // ------------------------------------------------------------------------
...
private fun NavigateScreenContent(
    ...
    var navigateTargetBounds by remember {
    ...
    Scaffold(
        ...
        Column(
            ...
            // =================================================================
            //
            // Wrapped inside Box so the tutorial can measure the exact
            // position of the search bar.
            //
            // DestinationSearchBar itself remains unchanged.
            // =================================================================
            ...
            onNext = {
                ...
                when (currentTarget) {
                    ...
                    TutorialTarget.NAVIGATE -> {
                        ...
                        // QR Handoff is located on ScanScreen.
                        // Move there so the next tutorial step has its
                        // correct target available.
                        navController.navigate(
                            Screen.Scan.route
                        )
                    }
